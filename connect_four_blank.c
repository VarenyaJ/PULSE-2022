...
void place_token(int game_board[rows][cols], int first_available_row[cols], int piece) {
    ...
    // int availableRow = __________________;
...
int isGameOver(int game_board[rows][cols], int piece) {
    ...
    // for (r = 0; r < rows; r++) {
    //     for (c = 0; c < cols - 3; c++) {
    //         if (game_board[r][c] == piece && ____________ && game_board[r][c + 2] == piece && ____________)
    //             return ___;
    //     }
    // }
    ...
    */ 
    ...
    // for (c = 0; c < cols; c++) {
    //     for (r = 0; r < rows - 3; r++) {
    //         if (game_board[r][c] == piece && ____________ && game_board[r + 2][c] == piece && ____________)
    //             return ___;
    //     }
    // }
    ...
    */
    ...
    // for (c = 0; c < cols - 3; c++) {
    //     for (r = 0; r < rows - 3; r++) {
    //         if (game_board[r][c] == piece && game_board[r + 1][c + 1] == piece && ____________ && ____________)
    //             return ___;
    //     }
    // }
...
int main() {
    ...
    do {
        ...
        switch(c) {
            ...
            case '\n':
                //**TODO**
                // THE USER PRESSED ENTER, SO LET'S PLACE THE TOKEN. (Hint: Call the function place_token)
                // ____________;

                // CHECK IF GAME IS OVER. (Hint: Call the function isGameOver)
                // if (____________) {
